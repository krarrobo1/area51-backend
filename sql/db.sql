...
INSERT INTO EMPRESAS(nombre, latitud, longitud, radio) VALUES('foo', 219.899, 110.000, 20.0);
...
INSERT INTO CARGOS(empresaid, nombre) VALUES(1, 'BOSS');
...
(
    id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
    dispositivoid integer references dispositivos(id),
    hora TIMESTAMP,
    latitud NUMERIC(9,6),
